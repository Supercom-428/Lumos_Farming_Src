...
export const mainnetTokens = defineTokens({
  ...
  lumosx: new Token(MAINNET,"0xdd05b1110147098b26fd3d457aa2992c034d3cfc",9,"LUMOSX","LumosMetaverse","https://lumos.world"),
  // cake: new Token(
  //   MAINNET,
  ...
  cake: new Token(
    MAINNET,
    '0xf18D878147AB27F5BCCeEb0DB4A2943fF6f173CD',
    18,
    'TORG',
    'Torg Token',
    'https://lumos.world',
