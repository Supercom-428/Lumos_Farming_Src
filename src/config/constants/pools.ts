...
export const vaultPoolConfig = {
  [VaultKey.CakeVault]: {
    ...
    gasLimit: 380000,
    tokenImage: {
      primarySrc: `/images/tokens/image.png`,
      secondarySrc: '/images/tokens/autorenew.svg',
    },
  },
  [VaultKey.IfoPool]: {
    name: 'QBANKX Sacrifice',
    description: 'Join the QBANKX sacrifice by spending LUSI or BNB',
    autoCompoundFrequency: 1,
    gasLimit: 500000,
    tokenImage: {
    primarySrc: `/images/tokens/image.png`,
    secondarySrc: `/images/tokens/`,
    },
  },
} as const
...
const pools: SerializedPoolConfig[] = [
  {
    ...
    contractAddress: {
      ...
      56: '0xFDF760d50F98328FFf12C2F2Da56C9AC11BD263B',
    },
