...
export const CreditCalcBlock = () => {
  ...
  return (
    <Flex mt="8px" justifyContent="space-between">
      <Text fontSize="14px">{hasEndBlockOver ? t('Release Rate:') : t('Release Rate:')}</Text>
...
const CakeVaultCard: React.FC<CakeVaultProps> = ({ pool, showStakedOnly, defaultFooterExpanded, ...props }) => {
  ...
  return (
    <div className=''>
      <div {...props}className='glass' isActive {...props} >
        ...
        <StyledCardBody className='transparent' isLoading={isLoading}>
