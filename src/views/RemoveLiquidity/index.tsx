...
export default function RemoveLiquidity({
  ...
  return (
    ...
    <Page className='transparent '>
      <div className='glass margin__b'>
        ...
        <CardBody>
          <AutoColumn gap="20px">
            <RowBetween>
              <Text>{t('Amount')}</Text>
              <Button className='btncolor2' variant="text" scale="sm" onClick={() => setShowDetailed(!showDetailed)}>
                {showDetailed ? t('Simple') : t('Detailed')}
              </Button>
            </RowBetween>
            {!showDetailed && (
              <BorderCard className='glass'>
                <Text className='margin__b'  fontSize="40px" bold mb="16px" style={{ lineHeight: 1 }}>
                ...
                <Button className='btncolor2 btncolor' scale="sm" onClick={() => onUserInput(Field.LIQUIDITY_PERCENT, '0')}>
                    0%
                  </Button>
                  <Button className='btncolor2 btncolor' scale="sm" onClick={() => onUserInput(Field.LIQUIDITY_PERCENT, '25')}>
                    25%
                  </Button>
                  <Button className='btncolor2 btncolor' scale="sm" onClick={() => onUserInput(Field.LIQUIDITY_PERCENT, '50')}>
                    50%
                  </Button>
                  <Button className='btncolor2 btncolor'  scale="sm" onClick={() => onUserInput(Field.LIQUIDITY_PERCENT, '75')}>
                    75%
                  </Button>
                  <Button className='btncolor2 btncolor'  scale="sm" onClick={() => onUserInput(Field.LIQUIDITY_PERCENT, '100')}>
                    Max
                  </Button>
                </Flex>
              </BorderCard>
          ...
          {!showDetailed && (
            <>
              ...
              <AutoColumn gap="10px">
                <Text className='btncolor2' bold fontSize="15px" textTransform="uppercase">
                  {t('You will receive')}
                </Text>
                <LightGreyCard className='glass margin__b'>
                  <Flex justifyContent="space-between" mb="8px">
                    <Flex>
                      <CurrencyLogo  currency={currencyA} />
                      <Text small className='btncolor2' id="remove-liquidity-tokena-symbol" ml="4px">
                        {currencyA?.symbol}
                      </Text>
                    </Flex>
                  ...
                  <Flex justifyContent="space-between">
                    <Flex>
                      ...
                      <Text className='btncolor2' small color="textSubtle" id="remove-liquidity-tokenb-symbol" ml="4px">
                        {currencyB?.symbol}
                      </Text>
                    </Flex>
          ...
          {pair && (
            <AutoColumn gap="10px" style={{ marginTop: '16px' }}>
              ...
              <LightGreyCard className='glass margin__b'>
                <Flex justifyContent="space-between">
                  <Text className='btncolor2' small >
                    1 {currencyA?.symbol} =
                  </Text>
                  <Text small>
      ...
      {pair ? (
        <AutoColumn className='glass transparent' style={{ minWidth: '20rem', width: '100%', maxWidth: '400px', marginTop: '1rem' }}>
