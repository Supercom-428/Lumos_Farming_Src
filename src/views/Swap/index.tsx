...
export default function Swap({ history }: RouteComponentProps) {
  ...
  return (
    <div className='main'>
      <div className='grid'>
        <ViewBalance />
        <Page removePadding={isChartExpanded} hideFooterOnDesktop={isChartExpanded} className='aside mar transparent'>
          <Navegation />
            ...
            <Flex width="100%" flexDirection="column">
              <StyledSwapContainer $isChartExpanded={isChartExpanded} >
                ...
                <CurrencyInputHeader
                  ...
                  isChartDisplayed={isChartDisplayed}
                />
                    <Wrapper id="swap-page" className='transparent aside '>
                      <AutoColumn >
                        <CurrencyInputPanel 
                          label={
                          ...
                          <AutoColumn gap="8px" style={{ padding: '0 16px' }}>
                            ...
                            {allowedSlippage !== INITIAL_ALLOWED_SLIPPAGE && (
                              <RowBetween align="center">
                                ...
                                <Text className='color2' bold color="primary">
                                  {allowedSlippage / 100}%
                                </Text>
                              </RowBetween>
                            )}
